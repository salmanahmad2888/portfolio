  ...
  return (
    <section id='home' className='max-w-contentContainer mx-auto py-10 mdl:py-24 flex flex-col gap-4 lgl:gap-8 mdl:px-10 xl:px-4'>
        ...
        className="text-base md:max-w-[650px] text-textDark font-medium">
            I am a data analyst with 4+ years of experience in Python, Machine Learning, Power BI. I have a strong foundation in data visualisation & SQL development and am skilled in creating user-friendly and responsive web applications using React and its ecosystem. {" "}
        ...
        <a href="https://github.com/salmanahmad2888" target="_blank">
            <motion.button initial={{y:10, opacity:0}} animate={{y:0, opacity:1}} transition={{duration:0.5, delay:0.9}}
